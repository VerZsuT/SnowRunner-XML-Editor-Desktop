...
const info = computed(() => new BaseLocalization<string[]>()
  ...
  .de([
    ...
    'Die Option für den Elementnamen Auto wurde hinzugefügt',
    'Definition der Systemsprache wurde korrigiert',
    'Fahrzeugelemente nach Dateien gruppieren hinzugefügt',
