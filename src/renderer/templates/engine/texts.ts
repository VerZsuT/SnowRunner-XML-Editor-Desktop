...
export const descs = localize({
    RU: {
        criticalDamageThreshold: "Порог повреждения (значение * 100 = процент), при котором двигатель будет вести себя как сломанный.",
    ...
    CH: {
        criticalDamageThreshold: "损伤阈值（值*100=百分比），在此阈值下，发动机将表现得像坏了一样。",
