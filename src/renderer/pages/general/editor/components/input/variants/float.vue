...
export type FloatProps = Props & EmitsToProps<NumberEmits>

type Props = IParameterProps<number, INumberAttrDescriptor> & Omit<NumberProps, 'type' | 'value'>
