...
import { selectFilter } from "pages/main/store/filterSlice";
import { toggleFavorite } from "pages/main/store/listSlice";
import { route } from "pages/main/store/pageSlice";
import { useMainDispatch, useMainSelector } from "pages/main/store/storeHooks";
...
const { saveEPF: openSaveDialog, paths } = main;
