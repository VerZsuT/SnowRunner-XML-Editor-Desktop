...
export const editorTexts = localize({
    RU: {
        SAVING_MESSAGE: 'Сохранение...',
        SUCCESS_SAVE_FILES: 'Сохранено',
        FILE_IS_RESETED: 'Параметры были сброшены',
    ...
    EN: {
        ...
        FILE_IS_RESETED: 'The parameters were reset.',
    ...
    DE: {
        ...
        FILE_IS_RESETED: 'Die Einstellungen wurden zurückgesetzt.',
