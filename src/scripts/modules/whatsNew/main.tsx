...
class WhatsNew extends PureComponent {
    ...
    render() {
        return (<>
            <h1 className='title'>{t.WHATS_NEW_TITLE} v0.6.6d</h1>
            <ol className='content'>
                {config.lang === Lang.RU? <>    
                    <li>Немного <i>изменён стиль</i> окон <b>Первая настройка</b> и <b>Настройки</b>.</li>
                    <li><i>Ускорена загрузка программы</i> при множестве добавленных модификаций.</li>
                    <li><i>Исправлена</i> работа числового поля ввода.</li>
                    <li><i>Исправлена</i> работа поля ввода координат.</li>
                    <li>При импорте конфига показывается сообщение на предыдущем языке.</li>
                </> :null}
                {config.lang === Lang.EN? <>
                    <li>Slightly <i>changed the style</i> of windows <b> First setting </b> and <b> Settings </b>.</li>
                    <li><i>Speed up loading of the program</i> with a lot of added modifications.</li>
                    <li><i>Fixed</i> the work of the numeric input field.</li>
                    <li><i>Fixed</i> work of the field for entering coordinates.</li>
                    <li>When importing a config, a message is shown in the previous language.</li>
                </> :null}
                {config.lang === Lang.DE? <>
                    <li>Leicht <i>geänderter Stil</i> von Fenstern <b> Erste Einstellung </b> und <b> Einstellungen </b>.</li>
                    <li><i>Beschleunigen Sie das Laden des Programms</i> mit vielen zusätzlichen Modifikationen.</li>
                    <li><i>Behoben</i> die Arbeit des numerischen Eingabefeldes.</li>
                    <li><i>Fixed</i> Arbeit des Feldes für die Eingabe von Koordinaten.</li>
                    <li>Beim Importieren einer Konfiguration wird eine Meldung in der vorherigen Sprache angezeigt.</li>
                </> :null}
            </ol>
            ...
            {config.lang === Lang.RU? <>
                ...
                <li>
                    Изменения параметров <i>двигателя</i>:
                    <ul>
                ...
                <li>
                    Исправлена <i>работа поиска в редакторе</i> параметров:
                    <ul>
            ...
            {config.lang === Lang.EN? <>
                ...
                <li>Changes in the parameters of the <i>engine</i>:
                    <ul>
                ...
                <li>
                    Fixed <i>search operation in the </i> parameters editor:
                    <ul>
            ...
            {config.lang === Lang.DE? <>
                ...
                <li>
                    Änderungen der Parameter des <i>Motors</i>:
                    <ul>
                ...
                <li>
                    Feste <i>Job-Suche im Editor</i> Parameter:
                    <ul>
