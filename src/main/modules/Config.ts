...
class Config {
  ...
  private static to068(exportedConfig: any): void {
  ...
  private static to067(exportedConfig: any): void {
  ...
  private static to066d(exportedConfig: any): void {
