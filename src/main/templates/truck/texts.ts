...
export const texts = {
	...
	ZH: {
		...
		winchLength: '绞车长度',
		winchStrength: '绞车力量',
		responsiveness: '方向盘灵敏度',
		torque: '驱动',
		torqueDefault: '永远领先',
		torqueFull: '全轮驱动驾驶',
		torqueNone: '奴隶',
		torqueConnectable: '由插件决定',
		steeringAngle: '旋转角度',
		centerOfMass: '质心的位移',
		any: '任何',
		none: '失踪',
		...
		UIName: '名称',
		controlGroupName: '管理',
		backSteerSpeed: '车轮返回速度',
		steerSpeed: '舵速',
		winchGroupName: '绞车',
		wheelsGroupName: '车轮',
		suspensionGroupName: '暂停',
		diffLock: '差速锁',
		installed: '已安装',
		uninstalled: '未安装',
		always: '总是',
		gearboxGroupName: '传输信号',
		engineGroupName: '引擎',
		engineStartDelay: '发动机启动延迟',
		exhaustStartTime: '排气开始时间',
		fuelGroupName: '燃油箱',
		damageCapacity: '耐久性',
		fuelCapacity: '体积',
		unlockGroupName: '解锁',
...
export const descs = {
	...
	ZH: {
		...
		UIDesc: '游戏中汽车的描述（或翻译键）',
		backSteerSpeed: '车轮在转弯后返回起始位置的速度',
		steerSpeed: '方向盘转动的速度。',
		isUpgradable: '绞车是否在改进',
		diffLock: '差速锁设置',
		exhaustStartTime: '排气可视化的开始时间。',
		engineStartDelay: '按"打开引擎"后延迟',
		damageCapacity: '油箱安全边际',
		fuelCapacity: '油箱内最大燃料量',
		country: '解锁国家',
		price: '汽车本身的价格（不包括组件）',
		byExploration: '解锁汽车的方法',
		unlockByRank: '车辆解锁级别',
		centerOfMass: '身体的质心相对于游戏引擎计算的质心的位移',
		torque: '车轮何时行驶',
		steeringAngle: '滑行时车轮转动的最大角度'
	}
}[Config.obj.lang]
