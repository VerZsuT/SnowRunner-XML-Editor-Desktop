...
export class Menu {
    ...
    static get = (): MenuTemplate[] => {
        ...
        {
            label: Texts.get('SETTINGS_MENU_LABEL'),
            submenu: [
                ...this.ifHasInitial([
                    {
                        label: Texts.get('SETTINGS_MENU_LABEL'),
                ...
                {
                    label: Texts.get('IMPORT_MENU_ITEM_LABEL'),
                    role: MenuRole.importConfig
                },
                ...this.ifHasInitial([{
                    label: Texts.get('EXPORT_MENU_ITEM_LABEL'),
                    role: MenuRole.exportConfig
                }]),
                ...this.ifHasInitial([
                    {
                ...
                { role: MenuRole.separator },
                {
                    label: Texts.get('UNINSTALL_MENU_ITEM_LABEL'),
                    role: MenuRole.uninstall
                }
            ]
        },
        {
            ...
            submenu: [
                {
                    label: Texts.get('VERSION_MENU_ITEM_LABEL'),
                    role: MenuRole.openWhatsNew
                },
                {
