...
class Config extends HasLinked {
    public obj: IConfig = this.getConfig();
     ...
     */
    @linkWithRenderAs("resetConfig")
    public reset(noReload?: boolean) {
        this.obj = {
    ...
    public import(fromBackups = true) {
    ...
    private before066d(exportedConfig: any) {
...
export const config = instance.obj;
