 ...
 * @param str
 */
export function removePars(str: string) {
    if (str || str === '') {
 ...
 */
export function fromDir(startPath: string, onlyDirs?: boolean, extension='.xml', inner?: boolean) {
...
export function openSaveDialog(defaultName: string) {
 ...
 */
export function openInitialDialog(): string | undefined {
    const result = dialog.showOpenDialogSync({
        properties: ['openFile'],
        filters: [{
            name: 'Pak file',
 ...
 */
export function openXMLDialog(): string | undefined {
    const result = dialog.showOpenDialogSync({
        properties: ['openFile'],
        filters: [{
            name: 'XML file',
